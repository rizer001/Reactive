...
val slf4jVersion = "2.0.18" // Leaf - Bump Dependencies
...
dependencies {
    ...
    api("org.yaml:snakeyaml:2.6") // Leaf - Bump Dependencies
    ...
    api("io.sentry:sentry:8.43.0") // Pufferfish
    ...
    api("org.apache.maven:maven-resolver-provider:3.9.16") // make API dependency for Paper Plugins
    ...
    val checkerQual = "org.checkerframework:checker-qual:3.55.1" // Leaf - Bump Dependencies
...
tasks.withType<Javadoc>().configureEach {
    ...
    options.links(
        ...
        "https://www.javadocs.dev/org.yaml/snakeyaml/2.6/", // Leaf - Bump Dependencies
        ...
        "https://www.javadocs.dev/org.apache.maven.resolver/maven-resolver-api/1.9.27", // Leaf - Bump Dependencies
    )
