...
// Reactive - Print warning for using deprecated snakeyaml's Base64Coder library
...
public class Base64Coder {
    ...
    private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger("Reactive"); // Reactive - Print warning for using deprecated snakeyaml's Base64Coder library
    ...
    static {
        ...
        map1[i++] = '+';
        map1[i++] = '/';
        warnOnInit(); // Reactive - Print warning for using deprecated snakeyaml's Base64Coder library
    }
    ...
    private static String encodeLines(byte[] in, int iOff, int iLen, int lineLen,
        ...
        while (ip < iLen) {
            ...
            buf.append(encode(in, iOff + ip, l, dummy)); // Reactive - Print warning for using deprecated snakeyaml's Base64Coder library
    ...
    private static byte[] decodeLines(String s, boolean dummy) {
        ...
        return decode(buf, 0, p, dummy); // Reactive - Print warning for using deprecated snakeyaml's Base64Coder library
    }
    ...
    private static void warn() {
        if (org.reactive.util.ReactiveConstants.ENABLE_BASE64CODER_WARNING) {
