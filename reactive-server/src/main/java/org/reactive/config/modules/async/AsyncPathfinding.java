...
import org.reactive.async.path.PathfindTaskRejectPolicy;
...
public class AsyncPathfinding extends ConfigModules {
    ...
    public void onLoaded() {
        ...
        if (enabled) {
            ReactiveConfig.LOGGER.info("Using {} threads for Async Pathfinding", asyncPathfindingMaxThreads);
            org.reactive.async.path.AsyncPathProcessor.init();
        }
    }
}
