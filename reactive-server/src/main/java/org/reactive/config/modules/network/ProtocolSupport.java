...
import org.reactive.protocol.DoABarrelRollPackets;
import org.reactive.protocol.DoABarrelRollProtocol;
...
public class ProtocolSupport extends ConfigModules {
    ...
    public static int xaeroMapServerID = ThreadLocalRandom.current().nextInt(); // Reactive - Faster Random
