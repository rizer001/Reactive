...
import org.reactive.config.annotations.DoNotLoad;
import org.reactive.config.annotations.HotReloadUnsupported;
...
public class RegionFormatConfig extends ConfigModules {
    ...
    public static boolean isReadOnlyMode() {
        return ReactiveConstants.LINEAR_V2_READ_ONLY && regionFormat == EnumRegionFormat.LINEAR_V2;
    }
    ...
    public void onLoaded() {
        ...
        if (regionFormat == EnumRegionFormat.LINEAR_V2) {
            ...
            if (isReadOnlyMode()) {
                ...
                LOGGER.error("then remove the JVM flag: -D{}=true", ReactiveConstants.LINEAR_V2_READ_ONLY_FLAG);
                LOGGER.error("============================================================");
            }
