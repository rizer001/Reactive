...
public class ReactiveGlobalConfig {
    ...
    public ReactiveGlobalConfig(boolean init) throws Exception {
        configFile = ConfigFile.loadConfig(new File(ReactiveConfig.I_CONFIG_FOLDER, ReactiveConfig.I_GLOBAL_CONFIG_FILE));

        ReactiveConfig.loadConfigVersion(getString("config-version"), CURRENT_VERSION);
    ...
    public Double getDouble(String path) {
        ...
        try {
            ...
            ReactiveConfig.LOGGER.warn("{} is not a valid number, skipped! Please check your configuration.", path, e);
            return null;
        }
    }
