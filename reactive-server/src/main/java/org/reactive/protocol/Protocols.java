...
public final class Protocols {
    ...
    public record TypeAndCodec<B extends FriendlyByteBuf, T extends ReactiveCustomPayload>(ReactiveCustomPayload.Type<T> type,
                                                                                       StreamCodec<B, T> codec) {
    }

    public static <B extends FriendlyByteBuf> void write(B byteBuf, ReactiveCustomPayload payload) {
    ...
    @Contract("_ -> new")
    public static ClientboundCustomPayloadPacket createPacket(ReactiveCustomPayload payload) {
        return new ClientboundCustomPayloadPacket(payload);
    }

    private static <B extends FriendlyByteBuf> void encode(B byteBuf, ReactiveCustomPayload payload, Protocol protocol) {
    ...
    private static @Nullable ReactiveCustomPayload decode(Protocol protocol, DiscardedPayload payload) {
