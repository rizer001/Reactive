...
public class DoABarrelRollPackets {
    ...
    private static <T extends ReactiveCustomPayload> ReactiveCustomPayload.Type<T> createType(String path) {
        return new ReactiveCustomPayload.Type<>(Identifier.fromNamespaceAndPath(DoABarrelRollProtocol.NAMESPACE, path));
    }

    public record ConfigResponseC2SPacket(int protocolVersion, boolean success) implements ReactiveCustomPayload {
    ...
    ) implements ReactiveCustomPayload {
    ...
    public record ConfigUpdateAckS2CPacket(int protocolVersion, boolean success) implements ReactiveCustomPayload {
    ...
    public record ConfigUpdateC2SPacket(int protocolVersion, ModConfigServer config) implements ReactiveCustomPayload {
    ...
    public record RollSyncC2SPacket(boolean rolling, float roll) implements ReactiveCustomPayload {
    ...
    public record RollSyncS2CPacket(int entityId, boolean rolling, float roll) implements ReactiveCustomPayload {
